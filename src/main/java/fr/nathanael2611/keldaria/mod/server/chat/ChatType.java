...
public abstract class ChatType
{
    ...
    public static final ChatType SPEAK = new ChatType(15) {
        ...
        {
            return new TextComponentString(TextFormatting.WHITE + " â—? " + TextFormatting.GRAY + RolePlayNames.getName(player) + TextFormatting.WHITE + " dit: " + message.substring(usedPrefix.length()));
        }
    };
    ...
    public static final ChatType LOW_SPEAK = new ChatType(6) {
        ...
        public ITextComponent format(EntityPlayer player, String usedPrefix, String message)
        {
            return new TextComponentString(TextFormatting.WHITE + " â—? " + TextFormatting.GRAY + RolePlayNames.getName(player) + TextFormatting.WHITE + " parle bas: " + message.substring(usedPrefix.length()));
        }
    };
    ...
    public static final ChatType LOUD_SPEAK = new ChatType(24) {
        ...
        public ITextComponent format(EntityPlayer player, String usedPrefix, String message)
        {
            return new TextComponentString(TextFormatting.WHITE + " â—? " + TextFormatting.GRAY + RolePlayNames.getName(player) + TextFormatting.WHITE + " parle fort: " + message.substring(usedPrefix.length()));
        }
    };
    ...
    public static final ChatType SHOUT = new ChatType(35) {
        ...
        public ITextComponent format(EntityPlayer player, String usedPrefix, String message)
        {
            return new TextComponentString(TextFormatting.RED + " â—? " + TextFormatting.GRAY + RolePlayNames.getName(player) + TextFormatting.RED + " crie: " + message.substring(usedPrefix.length()));
        }
    };
    ...
    public static final ChatType WHISP = new ChatType(4) {
        ...
        public ITextComponent format(EntityPlayer player, String usedPrefix, String message)
        {
            return new TextComponentString(TextFormatting.DARK_GREEN + " â—? " + TextFormatting.GRAY + RolePlayNames.getName(player) + TextFormatting.DARK_GREEN + " chuchote: " + message.substring(usedPrefix.length()));
        }
    };
    ...
    public static final ChatType LOCAL_NARR = new ChatType(15) {
        ...
        public ITextComponent format(EntityPlayer player, String usedPrefix, String message)
        {
            return new TextComponentString(TextFormatting.DARK_PURPLE + " â—? " + TextFormatting.LIGHT_PURPLE + "Â§o " + message.substring(usedPrefix.length()));
        }
    ...
    public static final ChatType GLOBAL_NARR = new ChatType(0) {
        ...
        public ITextComponent format(EntityPlayer player, String usedPrefix, String message)
        {
            return new TextComponentString(TextFormatting.DARK_RED + " â—? " + TextFormatting.RED + "Â§o " + message.substring(usedPrefix.length()));
        }
    ...
    public static final ChatType HRP = new ChatType() {
        ...
        public ITextComponent format(EntityPlayer player, String usedPrefix, String message)
        {
            ...
            return new TextComponentString( o+ " ( Â§7Â§o" + ChatUsernameAssets.getFormattedUsername(player) + o + " : " + message + o + " )");
        }
    ...
    public static final ChatType LOCAL_HRP = new ChatType(20) {
        ...
        public ITextComponent format(EntityPlayer player, String usedPrefix, String message)
        {
            message = message.substring(usedPrefix.length());
            String o = TextFormatting.DARK_GRAY + "" + TextFormatting.ITALIC;
            return new TextComponentString( " Â§fâ—? " + "Â§7" + RolePlayNames.getName(player) + " Â§f[HRP-LOCAL] Â§8Â§o(" +  o + "" + message + o + ")");
        }
