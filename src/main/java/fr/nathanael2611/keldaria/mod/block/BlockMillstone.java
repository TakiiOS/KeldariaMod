...
public class BlockMillstone extends Block
{
    ...
    public static final AxisAlignedBB PILLAR_AABB = new AxisAlignedBB(0.8, 0.0D, 0.8, 0.2, 0.8, 0.2);
    ...
    {
        return Item.getItemFromBlock(KeldariaBlocks.MILLSTONE);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            playerIn.playSound(KeldariaSounds.SHARPENING, 1F, 1);
            SharpeningHelpers.incrementSharpness(heldItem, 25 + Helpers.RANDOM.nextInt(40), playerIn);
            return true;
        }
