...
public class BlockClothingMannequin extends Block
{

    public static final PropertyDirection FACING = BlockHorizontal.FACING;

    public BlockClothingMannequin()
    {
        super(Material.WOOD);
    ...
    {
        return new TileEntityClothingMannequin();
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (tileentity instanceof TileEntityClothingMannequin) {
            InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityClothingMannequin) tileentity);
