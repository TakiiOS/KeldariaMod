...
/**
 * This class is simply à edited-copy-paste of the vanilla "BlockCrops" class.
 *
 * @author Mojang, Nathanael2611
 */
public class BlockCustomCrops extends BlockBush implements IGrowable
{
    ...
    protected BlockCustomCrops(int max)
    {
        AGE = PropertyInteger.create("age", 0, max);
    ...
    public void getDrops(net.minecraft.util.NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune)
    {
        ...
        Random rand = world instanceof World ? ((World)world).rand : Helpers.RANDOM;
