...
public class KeldAITempt extends EntityAIBase
{
    /**
     * The entity using this AI that is tempted by the player.
     */
    private final EntityKeldAnimal temptedEntity;
    ...
    public KeldAITempt(EntityKeldAnimal temptedEntityIn, double speedIn, Item temptItemIn, boolean scaredByPlayerMovementIn)
    {
        this(temptedEntityIn, speedIn, scaredByPlayerMovementIn/*, Sets.newHashSet(temptItemIn)*/);
    }

    public KeldAITempt(EntityKeldAnimal temptedEntityIn, double speedIn, boolean scaredByPlayerMovementIn/*, Set<Item> temptItemIn*/)
    {
    ...
    {
        return this.temptedEntity.isHungry() && this.temptedEntity.loveFood(stack.getItem());
    }
