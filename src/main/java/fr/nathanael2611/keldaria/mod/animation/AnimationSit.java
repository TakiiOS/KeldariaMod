...
public class AnimationSit extends Animation {
    public AnimationSit() {
        super("sit", false);
    }
    ...
    public void render(EntityPlayer player, ModelPlayer model, float partialTicks) {
        ...
        double translateYValue = 0.3;
        if(player.isSneaking()){
            translateYValue-=0.16;
        }
        ...
        model.bipedLeftArm.rotateAngleX-=0.6;
        model.bipedRightArm.rotateAngleX-=0.6;
        model.bipedLeftArm.rotateAngleY-=0.2;
