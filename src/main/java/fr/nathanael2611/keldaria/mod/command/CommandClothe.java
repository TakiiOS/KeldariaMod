...
import fr.nathanael2611.keldaria.mod.item.ItemSleepingMask;
...
public class CommandClothe extends KeldariaCommand
{
    ...
    public void run(CommandUser user, String[] args) throws CommandException
    {
        ...
        boolean isArmorInHand = user.asPlayer().getHeldItemMainhand().getItem() instanceof ItemArmor || user.asPlayer().getHeldItemMainhand().getItem() instanceof ItemSleepingMask || user.asPlayer().getHeldItemMainhand().getItem() instanceof ItemArmorPart;
