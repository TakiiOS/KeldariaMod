...
public class GuiKeyring extends GuiContainer
{
    ...
    private final InventoryKeyRing playerInventory;

    public GuiKeyring(EntityPlayer player, InventoryKeyRing ring)
    {
        super(new ContainerKeyring(ring, player.inventory));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GuiAPIClientHelper.drawItemStack(new ItemStack(KeldariaItems.KEYRING), i, j);
        fontRenderer.drawString("§8Porte-Clefs", i + 18, j + 6, Color.BLACK.getRGB(), false);
    }
