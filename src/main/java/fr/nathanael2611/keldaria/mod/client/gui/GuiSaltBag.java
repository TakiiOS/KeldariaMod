...
public class GuiSaltBag extends GuiContainer
{
    private static final ResourceLocation FURNACE_GUI_TEXTURES = new ResourceLocation(Keldaria.MOD_ID.toLowerCase(), "textures/gui/containers/salt_bag.png");
    /** The player inventory bound to this GUI. */
    private final TileEntitySaltBag playerInventory;

    public GuiSaltBag(EntityPlayer player, TileEntitySaltBag ring)
    {
        super(new ContainerSaltBag(player.inventory, ring));
