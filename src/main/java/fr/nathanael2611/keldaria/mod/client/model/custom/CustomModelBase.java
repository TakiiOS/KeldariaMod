...
public abstract class CustomModelBase
{
    ...
    public List<CustomModelRenderer> boxList = Lists.<CustomModelRenderer>newArrayList();
    ...
    public CustomModelRenderer getRandomModelBox(Random rand)
    {
     ...
     */
    public static void copyModelAngles(CustomModelRenderer source, CustomModelRenderer dest)
    {
    ...
    public void setModelAttributes(CustomModelBase model)
    {
