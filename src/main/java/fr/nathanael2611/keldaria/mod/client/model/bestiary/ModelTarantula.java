...
public class ModelTarantula extends ModelBestiary
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity) {
        if (entity instanceof EntityLivingBase) {
            ...
            float newLimbSwing = limbSwing + ModelBestiary.getSwingProgressPrev(living);

            this.head.rotateAngleY = ModelBestiary.getHeadYaw(living) * 0.017453292F;
            this.head.rotateAngleX = (float) Math.toRadians(ModelBestiary.getHeadPitch(living)) * 0.017453292F;
