...
public class GuiQuiver extends GuiContainer
{
    ...
    public GuiQuiver(EntityPlayer player, InventoryQuiver quiver)
    {
        super(new ContainerQuiver(player.inventory, quiver));
        this.quiver = quiver;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GuiAPIClientHelper.drawItemStack(new ItemStack(KeldariaItems.QUIVER), i, j);
        fontRenderer.drawString("§8Carquois", i + 18, j + 6, Color.BLACK.getRGB(), false);
