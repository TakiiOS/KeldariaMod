 ...
 */
package fr.nathanael2611.keldaria.mod.client.model.bestiary;
...
public class ModelBestiary extends ModelBase
{
    ...
    public static float getHeadYaw(EntityLivingBase base) {
        float yawOffset = interpolateRotation(base.prevRenderYawOffset, base.renderYawOffset, Minecraft.getMinecraft().getRenderPartialTicks());
        float yawHead = interpolateRotation(base.prevRotationYawHead, base.rotationYawHead, Minecraft.getMinecraft().getRenderPartialTicks());
