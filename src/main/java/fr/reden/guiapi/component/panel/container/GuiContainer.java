package fr.reden.guiapi.component.panel.container;
...
public class GuiContainer extends GuiFrame implements IMouseClickListener, IMouseExtraClickListener, IMouseMoveListener, IKeyboardListener, IGuiCloseListener, ITickListener
{
    /*
    ...
    {
        slots.forEach(slot -> {
            if(slot.isMouseOver(p_191948_1_, p_191948_2_))
            {
                System.out.println(slot.getSlot().getStack().copy());
                //GuiUtils.drawHoveringText(this.theSlot.getStack().copy(), p_191948_1_, p_191948_1_, resolution.getScaledWidth(), resolution.getScaledHeight(), 80, mc.fontRenderer);
                //this.renderToolTip(this.theSlot.getStack().copy(), p_191948_1_, p_191948_2_);
            }
        });
