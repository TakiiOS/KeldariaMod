...
public class GuiProgressBar extends GuiComponent {
    ...
    public void drawTexturedBackground(int mouseX, int mouseY, float partialTicks) {
		...
		drawString(mc.fontRenderer, progressText, getScreenX() + GuiAPIClientHelper.getRelativeTextX(progressText, getWidth(), horizontalTextAlignment), getScreenY() + GuiAPIClientHelper.getRelativeTextY(0, 1, getHeight(), verticalTextAlignment), progressTextColor);
